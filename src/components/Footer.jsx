export default function Footer(){
    return(
        <footer className={"fixed bottom-0 left-0 z-20 w-full bg-white shadow-sm dark:bg-gray-800"}>
            <div className={"w-full p-4 md:flex md:items-center md:justify-between"}>
                      <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2025 <a href="https://github.com/kirknasty54" className="hover:underline">Kirknasty Industries</a>. All Rights Reserved.
                      </span>
